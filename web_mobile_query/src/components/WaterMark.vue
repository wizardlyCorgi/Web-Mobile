...
export default {
  ...
  methods: {
    init () {
      ...
      ctx.font = 'normal 10px PingFangSC-Regular' // 设置样式
      ctx.fillStyle = 'rgba(112, 113, 114, 0.11)' // 水印字体颜色
      ctx.rotate((-20 * Math.PI) / 180) // 水印偏转角度
      ctx.textAlign = 'left'
      ctx.textBaseline = 'Middle'
      ctx.fillText(this.inputText, canvas.width / 6, canvas.height - 50)
